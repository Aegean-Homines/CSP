...
*/
/******************************************************************************/
INLINE void Variable::RemoveValue(Value val) throw (VariableException) {
...
*/
/******************************************************************************/
INLINE void Variable::Assign(Variable::Value val)  throw (VariableException) {
#ifdef DEBUG
...
*/
/******************************************************************************/
INLINE void Variable::Assign()  throw (VariableException) {
...
*/
/******************************************************************************/
INLINE Variable::Value Variable::GetMinValue() const throw (VariableException) {
...
*/
/******************************************************************************/
INLINE Variable::Value Variable::GetMaxValue() const throw (VariableException) {
	if ( is_assigned ) return assigned_value;
...
*/
/******************************************************************************/
INLINE Variable::Value Variable::GetValue() const throw (VariableException) {
...
*/
/******************************************************************************/
INLINE void Variable::UnAssign() throw (VariableException) {
	if ( !is_assigned ) 
